...
* [Руководство администратора](hostvm-vdi/hostvm-vdi-admin-guide/README.md)
  ...
  * [Настройка сервис-провайдеров](hostvm-vdi/hostvm-vdi-admin-guide/nastroika-servis-provaiderov.md)
  * [Настройка сервиса на основе провайдера HOSTVM](hostvm-vdi/hostvm-vdi-admin-guide/nastroika-servisa-na-osnove-provaidera-hostvm.md)
  * [Управление методами аутентификации](hostvm-vdi/hostvm-vdi-admin-guide/upravlenie-metodami-autentifikacii.md)
  * [Настройка менеджеров ОС](hostvm-vdi/hostvm-vdi-admin-guide/nastroika-menedzherov-os.md)
  * [Настройка транспорта подключения](hostvm-vdi/hostvm-vdi-admin-guide/nastroika-transporta-podklyucheniya.md)
  * [Настройка пула сервисов](hostvm-vdi/hostvm-vdi-admin-guide/nastroika-pula-servisov.md)
  ...
  * [Подключение внешних провайдеров аутентификации](hostvm-vdi/hostvm-vdi-admin-guide/podklyuchenie-vneshnikh-provaiderov-autentifikacii/README.md)
    * [Radius](hostvm-vdi/hostvm-vdi-admin-guide/podklyuchenie-vneshnikh-provaiderov-autentifikacii/radius.md)
    * [SAML](hostvm-vdi/hostvm-vdi-admin-guide/podklyuchenie-vneshnikh-provaiderov-autentifikacii/saml.md)
