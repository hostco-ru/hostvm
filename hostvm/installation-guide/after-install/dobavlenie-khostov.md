...
3\) Проблемы с зависимостями пакетов при установке - нужно сообщить об этой проблеме в поддержку по почте: presale.pvhostvm.ru, для исправления зависимостей в репозитории.
