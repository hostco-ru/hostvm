---
description: >-
  В статье приведены пошаговые требования и архитектурные ограничения для
  развертывания платформы виртуализации HOSTVM.
---

# Базовые условия для развертывания платформы виртуализации HOSTVM

Развертывание кластера HOSTVM возможно в конфигурации с одним хостом. Однако следует учитывать, что такая схема не обеспечивает высокой доступности и накладывает ряд функциональных ограничений. Однохостовая конфигурация допустима исключительно для тестовых стендов и не рекомендуется для использования в продуктивных инффраструктурах. Более подробная информация об ограничениях однохостовой конфигурации приведена в статье «[Особенности реализации кластеров в конфигурациях с одним хостом](../rukovodstvo-po-administrirovaniyu/vychislitelnaya-infrastruktura/klastery/osobennosti-realizacii-klasterov-v-konfiguraciyakh-s-odnim-khostom.md)».

Для развертывания платформы виртуализации HOSTVM в режиме высокой доступности требуется минимум:
