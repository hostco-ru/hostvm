...
1. Проверьте корректность вводимых данных в сценарии развёртывания. При обнаружении ошибок выполните команду `ansible-playbook /etc/ansible/clean-node.yml`, очистите хранилище и начните сначала.
