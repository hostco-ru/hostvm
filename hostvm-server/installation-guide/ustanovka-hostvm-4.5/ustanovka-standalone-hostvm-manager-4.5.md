---
description: >-
  В статье рассмотрена процедура развертывания HOSTVM Manager 4.5 в режиме
  Standalone на выделенном сервере.
---

# Установка Standalone HOSTVM Manager 4.5

В режиме Standalone HOSTVM Manager разворачивается на отдельно выделенном сервере c предварительно установленной операционной системой HOSTVM Node, в то время как в режиме Self-hosted на физическом хосте под управлением HOSTVM Node создается виртуальная машина HOSTVM Manager.
...
<figure><img src="https://raw.githubusercontent.com/hostco-ru/hostvm/master/.gitbook/assets/standalone_default_params.png" alt=""><figcaption></figcaption></figure>
