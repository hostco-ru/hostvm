...
В случае, если шаблоны, снапшоты или иные сущности были созданы с помощью стороннего ПО, например, внешних СРК (пр. КиберБекап), перезагрузите машину, на которой работает данное ПО.
