---
description: >-
  Данное руководство описывает возможности управления ВМ (запуск, остановка,
  миграция) при временной недоступности менеджера.
---

# Ограничения функциональности платформы при недоступности HOSTVM Manager

При отказе HOSTVM Manager платформа сохраняет базовую работоспособность, но большинство операций управления становятся недоступными.
