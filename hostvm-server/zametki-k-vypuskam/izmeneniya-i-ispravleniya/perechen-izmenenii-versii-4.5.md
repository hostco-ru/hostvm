...
### **Дата: 2026.01.21 Номер сборки: 202601211648**

#### HOSTVM Manager Setup

* Изменен устанавливаемый метод авторизации по умолчанию (Keycloak\[No]).

#### HOSTVM Manager

* Исправлена уязвимость: отключена возможность выполнения функции CreateUserSession из GWT.
* Добавлено восстановление SELinux контекста для базы grafana.db после выполнения операции engine-backup --mode=restore.

#### HOSTVM Node

* Изменены размеры разделов при автоматической разметке диска.
