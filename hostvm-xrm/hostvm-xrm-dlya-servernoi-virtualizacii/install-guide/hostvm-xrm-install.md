...
* Скачайте файл `HOSTVM XRM/Server/Beta/<номер версии>/hostvm-xrm<номер версии>.tar.bz2` из каталога загрузок HOSTVM.
...
* Выполните настройку системы согласно [Начальной настройке](../admin-guide/initial-setup.md) .
