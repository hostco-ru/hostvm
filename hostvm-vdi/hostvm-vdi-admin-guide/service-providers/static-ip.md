...
Данный тип сервис-провайдера позволяет предоставлять доступ к статичным машинам (как виртуальным так и физическим) с фиксированными IP-адресами, которые уже настроены и не создаются динамически. Данный провайдер позволяет управлять виртуальными машинами, разверуными на таких системах виртуализации как **Росплатформа, Базис, VMmanager, Hyper-V, KVM, Nutanix** и другие, для которых отсутствует выделенный провайдер.
