...
Здесь отображается перечень доступных сервис-пулов, с информацией о назначенных пользователям сервисах.
...
Вы можете предоставить доступ к управлению сервисами учетным записям с ролью "Оператор" с помощью разрешений.

{% hint style="warning" %}
Настройки доступа синхронизированы с соответствующими разрешениями для сервис-пулов в Панели управления.
{% endhint %}

Для этого отметьте нужный пул, нажмите кнопку "Разрешения" и добавьте учетную запись или группу с нужным уровнем доступа:

* Чтение: просмотр сервисов пула;
* Управление: просмотр и сброс сервисов пула.
