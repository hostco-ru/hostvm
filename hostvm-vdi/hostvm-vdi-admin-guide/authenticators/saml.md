...
Аутентификатор SAML позволяет пользователям и группам пользователей, принадлежащим к поставщику удостоверений с поддержкой SAML 2.0 получить доступ к виртуальным рабочим столам и приложениям. Данный аутентификатор позволяет аутентифицироваться с помощью таких внешних решений как **Мультифактор**, **Indeed**, **Avanpost**.
