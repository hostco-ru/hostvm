...
![п.3 Ввести IP-адрес брокера HOSTVM VDI](<../../../.gitbook/assets/image (18).png>)

![п.4 Выбрать тип подключения Actor к брокеру](<../../../.gitbook/assets/image (78).png>)

![п.5 Получить Master Key](../../../.gitbook/assets/base-img-pub4.png)

![п.6 Вставить полученный ключ](<../../../.gitbook/assets/image (29).png>)

![п.7 Проверка подключения](<../../../.gitbook/assets/image (16).png>)
...
В Alt Linux стандартный пакет `udsactor-3.0.0-1.noarch.rpm` не устанавливается из-за неразрешимых зависимостей.
...
`rpm -Uvh udsactor-3.0.0-1noarch.rpm`

[https://cloud.hostco.ru/s/rKHS3cPC6swQABr](https://cloud.hostco.ru/s/rKHS3cPC6swQABr)
