...
Для управления жизненным циклом виртуальных рабочих столов на основе технологии копирования, в базовый (“золотой”) образ гостевой операционной системы Windows [устанавливается агент HOSTVM VDI](../../hostvm-vdi-installation-guide/actor.md) из дистрибутива `UDSActorSetup-3.*.*.exe`.
...
Для управления жизненным циклом виртуальных рабочих столов на основе технологии копирования, в базовый (“золотой”) образ гостевой операционной системы Linux [устанавливается агент HOSTVM VDI](../../hostvm-vdi-installation-guide/actor.md).
