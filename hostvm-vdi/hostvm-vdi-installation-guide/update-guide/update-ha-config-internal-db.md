...
2.1  Выполните процедуру импорта новой версии ВМ брокера согласно статье ["Установка HOSTVM VDI Broker"](../hostvm-vdi-ova-install/), до момента авторизации в веб-интерфейсе управления (в двух экземплярах).
