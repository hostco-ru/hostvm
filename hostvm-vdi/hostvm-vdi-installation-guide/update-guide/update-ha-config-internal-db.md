...
2.1 Выполните процедуру импорта новой версии ВМ брокера согласно статье ["Установка HOSTVM VDI Broker"](../broker/virtual-appliance.md), до момента авторизации в веб-интерфейсе управления (в двух экземплярах).
...
3.1 Выполните процедуру настройки репликации базы данных между двумя серверами согласно [статье](../high-availability/db-replication/mariadb/).
