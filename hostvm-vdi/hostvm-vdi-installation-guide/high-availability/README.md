...
* [Установка HOSTVM VDI Broker](../broker/)
...
После завершения работы мастера скопируйте файл конфигурации брокера /var/server/server/settings.py на вторую машину и запустите на ней мастер установки.

После завершения работы мастера на каждой из ВМ убедитесь, что веб-интерфейс HOSTVM VDI доступен.

## **Конфигурация шлюза** <a href="#vdi-tunneler" id="vdi-tunneler"></a>

Разверните два экземпляра виртуальной машины шлюза HOSTVM VDI:

* [Установка HOSTVM VDI Tunneler](../tunneler/)
