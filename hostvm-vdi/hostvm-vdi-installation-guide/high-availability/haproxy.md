...
Процесс развертывания и настройки машин HOSTVM VDI Tunneler описан в [соответствующей статье](../tunneler-appliance-deploy/).
...
После завершения настройки машин VDI Tunneler необходимо [изменить настройки туннелируемых подключений в панели управления брокера](../tunneler-appliance-deploy/#transport-config).
