...
* Скачать образ машины `HOSTVM-VDI/hostvm-tunneler-`<номер сборки>`.tar.bz2` из каталога загрузок HOSTVM.
* Загрузить данный файл на один из хостов виртуализации к HOSTVM с помощью scp или других средств.
* Распаковать: `tar xjvf hostvm-tunneler-`<номер сборки>`.tar.bz2`&#x20;
