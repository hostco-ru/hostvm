...
### Импорт виртуальной машины <a href="#vm-import" id="vm-import"></a>
...
### Импорт виртуальной машины <a href="#vm-import-30" id="vm-import-30"></a>
...
### Настройка сети <a href="#network-config-30" id="network-config-30"></a>
...
#### Сертификат для HTML5 подключений <a href="#html5-certificate-30" id="html5-certificate-30"></a>
...
### Настройка транспорта в панели управления брокера <a href="#transport-config-30" id="transport-config-30"></a>
